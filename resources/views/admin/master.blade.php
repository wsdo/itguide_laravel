           ...
           <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        <a href="index.html"><i class="fa fa-th-large"></i> <span class="nav-label">文章</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li class="active"><a href="edit">所有文章</a></li>
                            <li><a href="post-new">写文章</a></li>
                            <li><a href="edit-tags">分类目录</a></li>
                            <li><a href="dashboard_4_1.html">标签</a></li>
                        </ul>
                    </li>
                    <li>
...
<!-- Mainly scripts -->
    ...
    <script src="/admin/js/plugins/dataTables/datatables.js"></script>

    <!-- Toastr -->
    <script src="/admin/js/plugins/toastr/toastr.min.js"></script>
    <script src="/admin/js/article/list.js"></script>
